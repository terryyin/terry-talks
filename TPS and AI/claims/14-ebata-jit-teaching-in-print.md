...
> **ジャストインタイム**
>
> 顧客の声に従う（事実 ← 体験、コラボーレーション）
>
> ある物で工夫する（事実 ← コラボーレーション）
>
> 早く提供する（提供者の希望 = 提供者の希望）
>
> 開発者の想像を破棄する（スキル = スキル）
>
> **大野耐一:** 余計なことはするな！
...
The closest match complicates a literal reading rather than confirming
it. A Nikkei xTech piece is headlined **"大野耐一の教え、答えは顧客から
得られない"** ("Ohno's teaching: the answer is not obtained from the
customer") — Ohno's point there is that the engineer must think from
the customer's position and act on facts, not transcribe the customer's
literal request. That is closer to Terry's own parenthetical
classification (**fact ← experience, collaboration**, not "customer's
stated wish") than to a stage phrase that sounds like literal
customer-survey deference. Use the parenthetical, not a bare "follow
the customer's voice," if this line goes on stage.

### Line 2 — ある物で工夫する (be resourceful with what you have)

Genuine, repeatedly attested Ohno theme, though not this four-word
phrasing. A widely reproduced quote in secondary compilations: **"Man
Powerは決しておし計れるものではない。知恵を出すことによって、能力は
無限に拡大される"** (manpower cannot be calculated; wisdom expands
capability infinitely). Paired with the documented sequence **作業改善
から設備改善へ** (improve the work method — with what exists — before
investing in new equipment). Family resemblance is strong; no source
gives this exact sentence.

### Line 3 — 早く提供する (deliver quickly)

Ohno's own definition of JIT is **not** raw speed: "in time" means
making it exactly when needed, not as fast as possible. A directly
fetched secondary recollection (Itoh Yoshiya, MIE System Lab) puts this
as a caution in Ohno's own voice: someone boasts changeover now takes
so many minutes, but *"速く段取りができても、売れる以上に作りすぎたら
何にもならんのでね"* (however fast the changeover, overproducing beyond
what sells is worthless). If this line is used on stage, keep "quickly"
tied to actual need, not to speed for its own sake — otherwise the talk
would misstate the very teaching it cites.

### Line 4 — 開発者の想像を破棄する (discard the developer's imagination)
...
> handed over by the customer, it's found by thinking from their
> position; capability grows through wisdom, not more resources;
> "in time" means exactly when needed, not merely fast; and firsthand
> fact beats secondhand assumption.**

If a line goes on stage, prefer the qualified reading over the bare
four-word gloss — especially line 1, where the published Ohno framing
(answers are not obtained *from* the customer) actually cuts against a
literal "follow the customer's voice."
...
1. Kazumasa Ebata, oral teaching shared with Terry. Not a published source.
2. [大野耐一の鬼十訓](https://masaki0303.hatenadiary.org/entry/20101107/1289118951)
   (secondary compilation, fetched in full). Ten precepts attributed to
   Ohno; none match "余計なことはするな."
3. [大野耐一語録](https://www.cpc.or.jp/ie/pages/20/), Chubu Industrial
   Engineering Association (secondary compilation, no book citations
   given per item). Source of the "Man Power... 知恵を出すことによって、
   能力は無限に拡大される" line.
4. [大野耐一先生の言葉](https://mie-system.com/pg60.html) and its
   [continuation](https://mie-system.com/pg62.html), MIE System Lab
   (Itoh Yoshiya's recollections; secondary, not Toyota-published).
   Source of the changeover-speed-vs-overproduction caution.
5. [大野耐一](https://www.hri-japan.co.jp/contents_library/wcl_leader/wcl_leader_03_5/),
   HR Institute (secondary compilation). Source of "百聞は一見にしかず、
   百見は一行にしかず" and "why five times"; no match for the four lines
   or the coda.
6. [大野耐一の教え、答えは顧客から得られない](https://xtech.nikkei.com/dm/atcl/feature/15/032800085/032800008/),
   Nikkei xTECH. Ohno's teaching that the answer is not obtained
   directly from the customer's stated words; think from the customer's
   position instead. Closest, and qualifying, match for line 1.
