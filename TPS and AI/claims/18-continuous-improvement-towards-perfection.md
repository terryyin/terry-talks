...
> principle and traces it to Toyota via lean thinking. It did not invent
> it. Toyota Way 2001 names the pillar Continuous Improvement: “We are
> never satisfied with where we are.” Womack and Jones name pursue
...
LeSS lists **Continuous Improvement Towards Perfection** among its core
principles. The overview statement is:
...
There is no change initiative, no change group, no change managers.
Change is the status quo. When is LeSS adoption done? Never. When is
improvement finished? Never.
...
Toyota Way 2020 is ten actions toward the Toyota Philosophy, not a
...
(delighting features, almost no defect/effort/cost, turn on a dime for a
dime, extraordinary skill) are a challenge, not a finish line. Adoption
guidance uses a **perfection vision**: Toyota's classic Just-in-Time /
one-piece flow (every customer purchase produces exactly one car), and
the LeSS vision it sometimes uses:
...
16](16-go-see-ai-harness.md),
[12](12-respect-for-people-who-can-think.md),
[17](17-jit-vertical-slicing-one-piece-flow.md),
[6](06-jidoka-embeds-routine-judgment.md),
[2](02-tps-and-lean-houses.md), and
[5](05-smed-software-changeover-and-ai-friendly-context.md). Claim 5
already distinguishes deliberate changeover from mid-Sprint
interruption, so “turn on a dime for a dime” does not overpromise the
Sprint goal.
