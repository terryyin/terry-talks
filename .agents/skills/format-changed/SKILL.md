...
name: format-changed
description: >-
  Prepare working-tree changes for commit by selectively formatting affected
  components. Use after implementation and refactoring but before staging;
  stop when a formatter or lint result needs semantic or design judgment.
---
